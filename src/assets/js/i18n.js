...
const EXTRA_LOCALE = {
  en: {
    ...
    config: {
      ...
      blockedIps: 'Blocked Target IPs', blockedIpsHint: 'Block traffic to specified IPs. Supports single IP or CIDR ranges. Only IP targets are affected; domains are not. Restart local proxy to take effect.',
      ...
      blockedIpsHintAfterExamples: '. Only IP targets are affected; domains are not. Restart local proxy to take effect.',
  ...
  zh_cn: {
    ...
    config: {
      ...
      blockedIps: '目标 IP 封锁', blockedIpsHint: '封锁发往指定 IP 的流量，支持单个 IP 或 CIDR 网段。仅当目标地址为 IP 时生效，域名不影响。修改后需重启本地代理生效。',
      blockedIpsHintBeforeSingle: '封锁发往指定 IP 的流量，支持单个 IP（如 ',
      blockedIpsHintBetweenExamples: '）或 CIDR 网段（如 ',
      blockedIpsHintAfterExamples: '）。仅当目标地址为 IP 时生效，域名不影响。修改后需重启本地代理生效。',
  ...
  zh_tw: {
    ...
    config: {
      ...
      blockedIps: '目標 IP 封鎖', blockedIpsHint: '封鎖發往指定 IP 的流量，支援單一 IP 或 CIDR 網段。僅當目標地址為 IP 時生效，網域不受影響。修改後需重啟本地代理生效。',
      blockedIpsHintBeforeSingle: '封鎖發往指定 IP 的流量，支援單一 IP（如 ',
      blockedIpsHintBetweenExamples: '）或 CIDR 網段（如 ',
      blockedIpsHintAfterExamples: '）。僅當目標地址為 IP 時生效，網域不受影響。修改後需重啟本地代理生效。',
  ...
  ja: {
    ...
    config: {
      ...
      blockedIps: 'ターゲット IP ブロック', blockedIpsHint: '指定 IP への通信をブロックします。単一 IP または CIDR をサポートします。対象が IP の場合のみ有効で、ドメインには影響しません。変更後はローカルプロキシを再起動してください。',
      blockedIpsHintBeforeSingle: '指定 IP への通信をブロックします。単一 IP（例: ',
      blockedIpsHintBetweenExamples: '）または CIDR（例: ',
      blockedIpsHintAfterExamples: '）をサポートします。対象が IP の場合のみ有効で、ドメインには影響しません。変更後はローカルプロキシを再起動してください。',
